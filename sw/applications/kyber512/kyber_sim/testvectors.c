...
int main(void) {
  	uint8_t key_a[PQCLEAN_KYBER512_CLEAN_CRYPTO_BYTES], key_b[PQCLEAN_KYBER512_CLEAN_CRYPTO_BYTES];
	...
	for (i1 = 0; i1 < PQCLEAN_KYBER512_CLEAN_CRYPTO_PUBLICKEYBYTES; i1++) {
	...
	printf("pk.txt file completed!\n");
		...
		for (i2 = 0; i2 < PQCLEAN_KYBER512_CLEAN_CRYPTO_SECRETKEYBYTES; i2++) {
	...
	for (i3 = 0; i3 < PQCLEAN_KYBER512_CLEAN_CRYPTO_CIPHERTEXTBYTES; i3++) {
	...
	for (i4 = 0; i4 < PQCLEAN_KYBER512_CLEAN_CRYPTO_BYTES; i4++) {
